...
header2     db "UNIVERSIDAD DE SAN CARLOS DE GUATEMALA",10,"FACULTAD DE INGENIERIA",10,"CIENCIAS Y SISTEMAS",10,"ARQUITECTURA DE COMPUTADORAS Y ENSAMBLADORES 1",10,"NOMBRE: AYUDA MUTUA",10,"CARNET: 2016XXXX",10,"SECCION: A",10,'$'
...
arrayTop    db 300 dup ('$')
auxTop      db 5 dup ('$')
top1File    db "c:\top1.txt",0  ;top players
top2File    db "c:\top2.txt",0  ;top time
auxd        db 5 dup ('$')
;------sorting------
...
userFile    db "c:\users.txt",0
;inputFile   db 50 dup ('$')
inputFile   db "c:\entrada.ply",0    ;bugs with other extension
repFile     db "c:\puntos.rep",0
